...
public class DbExportImport {
    ...
    protected static final File DATABASE_DIRECTORY =
            new File(Environment.getExternalStorageDirectory(), "PanoCatcher");
    ...
    public static boolean exportDb() {
        ...
        String filename = DbConfig.DB_NAME_2  + "_" +getDateTime()+ ".db";
     ...
     **/
    public static boolean restoreDb(String filename, Context context) {
        if (!SdIsPresent()) return false;

        //String filename = DbConfig.DB_NAME_2  + ".db";
       // File sd = Environment.getExternalStorageDirectory();


        File importFile = new File(DATABASE_DIRECTORY,filename);
        ...
        if (!checkDbIsValid(importFile)) {
            ...
            AlertDialogForAnything.showAlertDialog(context,"Error","Your database isn't valid",false);
            return false;
        }
        ...
        if (!importFile.exists()) {
            ...
            AlertDialogForAnything.showAlertDialog(context,"Error","Your File Does Not Exist. Please give a valid Path",false);
            return false;
        }
