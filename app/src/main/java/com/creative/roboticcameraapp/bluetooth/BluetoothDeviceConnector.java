...
package com.creative.roboticcameraapp.bluetooth;
...
public class BluetoothDeviceConnector {
    ...
    public BluetoothDeviceConnector(BluetoothDeviceData bluetoothDeviceData, Handler handler) {
        mHandler = handler;
        btAdapter = BluetoothAdapter.getDefaultAdapter();
        connectedDevice = btAdapter.getRemoteDevice(bluetoothDeviceData.getAddress());
        deviceName = (bluetoothDeviceData.getName() == null) ? bluetoothDeviceData.getAddress() : bluetoothDeviceData.getName();
        mState = STATE_NONE;
    }
    // ==========================================================================
