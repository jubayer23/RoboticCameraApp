package com.creative.roboticcameraapp.utils;

import android.bluetooth.BluetoothDevice;
import android.os.ParcelUuid;


import com.creative.roboticcameraapp.bluetooth.BluetoothUtils;
...
public class BluetoothDeviceData {
    ...
    public BluetoothDeviceData(BluetoothDevice device, String emptyName) {
        name = device.getName();
