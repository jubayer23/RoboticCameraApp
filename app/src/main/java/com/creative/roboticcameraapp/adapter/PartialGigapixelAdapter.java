...
public class PartialGigapixelAdapter extends BaseAdapter {

    private List<Partial> Displayedplaces;
    private List<Partial> Originalplaces;
    ...
    public PartialGigapixelAdapter(Activity activity, List<Partial> histories, boolean IS_FROM_HOME) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final Partial partial = Displayedplaces.get(position);


        viewHolder.single_row_name.setText(partial.getPartialName());
        ...
        if (!is_from_home) {
            viewHolder.btn_delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    dialogShowWarning(partial.getId(), position);
            ...
            viewHolder.btn_edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (listener != null) {
                        listener.onEdit(partial.getId(), position);
                    }
                }
            });
        } else {
    ...
    private void dialogShowWarning(final int id, final int position) {
        ...
        tv_warning.setText("Are you sure to delete this Partial/Gigapixel Profile?");
        ...
        btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AppController.getInstance().getsqliteDbInstance().deletePartialGigapixel(id);
