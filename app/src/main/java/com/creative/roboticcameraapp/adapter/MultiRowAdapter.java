...
public class MultiRowAdapter extends BaseAdapter {

    private List<MultiRow> Displayedplaces;
    private List<MultiRow> Originalplaces;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.multi_row_name = (TextView) convertView
        ...
        final MultiRow multiRow = Displayedplaces.get(position);
    ...
    private void dialogShowWarning(final int id, final int position) {
        ...
        tv_warning.setText("Are you sure to delete this Multi Row 360 Profile?");
