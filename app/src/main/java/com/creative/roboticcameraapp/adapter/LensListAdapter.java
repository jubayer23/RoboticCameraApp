...
public class LensListAdapter extends BaseAdapter {

    private List<Lens> Displayedplaces;
    private List<Lens> Originalplaces;
    ...
    public LensListAdapter(Activity activity, List<Lens> histories) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.lens_name = (TextView) convertView
        ...
        final Lens camera = Displayedplaces.get(position);


        viewHolder.lens_name.setText(camera.getLensName());
    ...
    private void dialogShowWarning(final int id, final int position) {
        ...
        btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AppController.getInstance().getsqliteDbInstance().deleteLens(id);
